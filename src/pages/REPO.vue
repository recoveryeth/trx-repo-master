<template>
  <div id="epro">
    ...
    <div class="box yellow">
      ...
      <div class="right">
        <div class="row">
          <div class="label">{{$t('epro.content_20')}}:</div>
          <div class="value">{{total_dugout | floor}}</div>
        </div>
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="value">{{parseFloat(totalInvestment) * 0.03 | floor}}USDT</div>
        </div>
        <div class="row">
          <div class="label">{{$t('epro.content_6')}}:</div>
          <div class="value">{{totalProfited | floor}}USDT</div>
        </div>
        <div class="row">
          <div class="label">{{$t('epro.content_7')}}:</div>
          <div class="value">{{parseFloat(totalInvestment) * 0.03 - parseFloat(totalProfited) | floor}}USDT</div>
        </div>
      </div>
    </div>
    <div class="box blue">
      <div class="left">
        ...
        <div class="epro-summary">
          <span class="amount">{{balanceOfToken | floor}}</span><span class="symbol">REPO</span>
        </div>
      </div>
      <div class="right">
        <div class="btn-group">
