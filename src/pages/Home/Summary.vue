  ...
  <div id="summary">
    <section v-show="!chart_loading">
      <table class="table0">
        ...
        <tr>
          <td>
            <span>{{$t('TREND.LEFT.PRICE')}}(USDT)</span>
          </td>
          <td>
      ...
      <table class="table1">
        <tr>
          <td>
            ...
            <span class="number"><ICountUp :endVal="truncation(exchange_last_price, 8)" :options="{decimalPlaces: 8}"/>USDT</span>
          </td>
          <td>
            <span>{{$t('TREND.RIGHT.VOLUME')}}</span>
            <span class="number"><ICountUp :endVal="truncation(exchange_vol_24h, 2)" :options="{decimalPlaces: 2}"/>USDT</span>
          </td>
        </tr>
        <tr>
          <td>
